...
namespace TriggersTools.DiscordBots.Database.Model {
	/// <summary>
	/// A unique set of strings that are added and replaced from one large string at runtime.<para/>
	...
	public class StringSet : ICollection<string>, IReadOnlyCollection<string> {
		...
		/// <summary>
		/// Constructs an empty <see cref="StringSet"/>.
		/// </summary>
		public StringSet() {
			Text = Delimeter;
		}
		/// <summary>
		/// Constructs the <see cref="StringSet"/> with the specified text.
		/// </summary>
		public StringSet(string text) {
