...
namespace TriggersTools.DiscordBots.TriggerChan {
	public class Startup {
		...
		public async Task RunAsync() {
			...
			provider.GetRequiredService<AudioService>();      // Start the logging service
			provider.GetRequiredService<LoggingService>();      // Start the logging service
			provider.GetRequiredService<CommandHandler>();      // Start the command handler service
			provider.GetRequiredService<SpoilerService>();      // Start the command handler service
		...
		private void ConfigureServices(ServiceCollection services) {
			...
			.AddSingleton<AudioService>()         // Add loggingservice to the collection
			.AddSingleton<SpoilerService>()         // Add loggingservice to the collection
