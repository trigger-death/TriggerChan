...
namespace MALClient.XShared.Comm.Profile {
	public struct ProfileQueryArgs {
		public bool Stats { get; set; }
		public bool FavoriteAnime { get; set; }
		public bool FavoriteManga { get; set; }
		public bool FavoriteChars { get; set; }
		public bool FavoritePeople { get; set; }
	...
	public class ProfileQuery : Query {
		...
		public async Task<ProfileData> GetProfileData(bool force = false, bool updateFavsOnly = false, bool baseData = true) {
			try {
				...
				using (var client = new HttpClient()) {
					var raw = !updateFavsOnly
						? await (await client.GetAsync($"https://myanimelist.net/profile/{_userName}")).Content.ReadAsStringAsync()
		...
		public async Task<List<MalComment>> GetComments() {
			...
			using (var client = new HttpClient()) {
				raw = await client.GetAsync($"https://myanimelist.net/profile/{_userName}");
