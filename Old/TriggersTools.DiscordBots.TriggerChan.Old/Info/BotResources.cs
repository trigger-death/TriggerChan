...
namespace TriggersTools.DiscordBots.TriggerChan.Info {
	public static class BotResources {
		...
		public static readonly string Disgusting = GetImage("Disgusting.png");
		public static readonly string Dont_Touch_Me_Pervert = GetImage("Dont_Touch_Me_Pervert.png");
